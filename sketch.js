...
function setup() {
  ...
  box5 = new Box(550, 100, 70, 70);
  box6 = new Box(550, 100, 70, 70);
  box7 = new Box(550, 100, 70, 70);
  box8 = new Box(600, 100, 70, 70);
  box9 = new Box(600, 100, 70, 70);
  box10 = new Box(900, 100, 70, 70);
  box11= new Box(900, 100, 70, 70);
  box12 = new Box(550, 100, 70, 70);
  box13 = new Box(550, 100, 70, 70);
  box14 = new Box(550, 100, 70, 70);
